DEMO.Hypercomplex = DEMO.ShadertoyBase.extend(function(canvas){
	var shader = [
		...
		'    float time = iGlobalTime * 0.07;',
		'    float ang = time + iMouse.x/iResolution.x * 3.0;',
	...
	DEMO.Hypercomplex.parent.call(this, canvas, shader, 0.8);
});
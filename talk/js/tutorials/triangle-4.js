/*
	...
	Simple triangle webgl demo, v4

*/

DEMO.Triangle4 = DEMO.Demo.extend(function(canvas){
	DEMO.Triangle4.parent.call(this, canvas);//super
...
DEMO.Triangle4.prototype.render = function(dt){
...
DEMO.Triangle4.prototype.setSize = function(w, h){
	this.canvas.width = w;
...
DEMO.Triangle4.prototype.setPixelShader = function(pixelShaderSrc){
	this.pixelShaderSrc = pixelShaderSrc;
	this.shadersNeedCompile = true;
}

DEMO.Triangle4.prototype.setGeometryShader = function(geometryShaderSrc){
	this.geometryShaderSrc = geometryShaderSrc;
	this.shadersNeedCompile = true;
}

DEMO.Triangle4.prototype._compileShaders = function(geometryShaderSrc, pixelShaderSrc){
	var gl = this.gl;

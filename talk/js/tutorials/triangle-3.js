/*
	...
	Simple triangle webgl demo, v3

*/

DEMO.Triangle3 = DEMO.Demo.extend(function(canvas){
	DEMO.Triangle3.parent.call(this, canvas);//super
	...
	this.pixelShaderSrc = [
		...
		'void main(){',
		'	vec3 col = vec3(0);',
		'	col.r = sin(time * 1.0 + uv.x * 20.)*.5 + .5;',
...
DEMO.Triangle3.prototype.render = function(dt){
...
DEMO.Triangle3.prototype.setSize = function(w, h){
	this.canvas.width = w;
...
DEMO.Triangle3.prototype.setPixelShader = function(pixelShaderSrc){
	this.pixelShaderSrc = pixelShaderSrc;
	this.shadersNeedCompile = true;
}

DEMO.Triangle3.prototype.setGeometryShader = function(geometryShaderSrc){
	this.geometryShaderSrc = geometryShaderSrc;
	this.shadersNeedCompile = true;
}

DEMO.Triangle3.prototype._compileShaders = function(geometryShaderSrc, pixelShaderSrc){
	var gl = this.gl;
